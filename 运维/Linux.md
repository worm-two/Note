...
* 在当前Shell中打开一个子Shell来执行脚本内容，当脚本内容结束，则子Shell关闭回到父Shell中
...
定义在函数内部,使用==local==关键字修饰

###### 全局变量

Shell中定义的变量默认是全局变量,作用在当前Shell及子Shell
...
1. Shell中定义的变量默认是全局变量,故函数内定义的变量函数外也可以调用
2. local关键字可以限制变量只在函数内部使用
